          ...
          <div className="col-md-10 col-lg-6 col-xl-5 col-xxl-3 offset-xxl-1">
            <div className="footer-inner">
              ...
              >
                ...
                <button
                  className="btn-secondary font-medium !w-[9rem] mobile-425:!w-[11rem] 2xl-1600:!w-[12.5rem]  mx-auto py-[.7rem] mobile-400:mt-0 mobile-400:py-0 px-4 pr-20 !text-[1rem] lg-992:w-full "
                  type="submit"
                >
                  Subscribe
                </button>
